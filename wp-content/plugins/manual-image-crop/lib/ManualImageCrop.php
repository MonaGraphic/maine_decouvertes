...
class ManualImageCrop {
	...
	public function enqueueAssets() {
		// Only users who can work with media need crop UI + nonce (avoids exposing nonce to Subscribers).
...
<?php
	...
	private function filterPostData() {
		...
		// Always reuse the ID authorized in mic_ajax_authorize_crop_image() — never re-parse with a different sanitizer.
		...
		$data = array(
				'attachmentId' => absint( $GLOBALS['mic_authorized_attachment_id'] ),
